...
- `lovelace/_archive/legacy_dashboards/02_air_loop_legacy.yaml`
- `lovelace/02_air_loop.yaml`
- `lovelace/03_heating_loop.yaml`
- `lovelace/_archive/legacy_dashboards/04_cooling_loop_legacy.yaml`
...
FILE: lovelace/_archive/legacy_dashboards/02_air_loop_legacy.yaml
<contenuto aggiornato>

FILE: lovelace/02_air_loop.yaml
<contenuto aggiornato>
